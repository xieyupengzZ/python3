...
3、金证使用pl/sql操作oracle数据库，但是pl/sql目前只有32位的，所以本地的oracle客户端安装的也必须是32位的
4、所以cx_oracle也必须安装32位的
5、进入阿里云镜像地址：https://mirrors.aliyun.com/pypi/simple/，选择cx_oracle包32位的whl文件
6、通过 pip install xxx.whl 的方式直接安装
7、如果64位的python不能安装32位的包，就需要在本地再下载一个32位的python
version: 1.0
Author: xieyupeng
Date: 2020-09-07 15:16:32
LastEditors: xieyupeng
LastEditTime: 2020-10-09 15:01:40
'''
import cx_Oracle
